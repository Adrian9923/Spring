...
import softuni.dto.ProductRootDto;
import softuni.dto.ProductXmlDto;
...
public class ProductServiceImpl implements ProductService {
    ...
    private final String PRODUCTS_FILE_XML_PATH = "C:\\Users\\Legion\\Desktop\\productsShop\\productsShop\\src\\main\\resources\\static\\files\\xml\\products.xml";
    ...
    public ProductServiceImpl(Gson gson, XmlParser xmlParser, ModelMapper modelMapper, ProductRepository productRepository, UserRepository userRepository, CategoryRepository categoryRepository) {
        this.gson = gson;
    ...
    @Override
    public void registerXmlProducts() throws JAXBException, IOException {
        ProductRootDto productRootDto = this.xmlParser
                .parseXml(ProductRootDto.class, this.PRODUCTS_FILE_XML_PATH);

        for (ProductXmlDto productXmlDto : productRootDto.getProducts()) {
    ...
    @Override
    public void exportProductsInRangeWithoutBuyerToJson(BigDecimal minPrice, BigDecimal maxPrice, String filePath) throws IOException {
        List<Object[]> products = productRepository.findProductsInRangeWithoutBuyer(minPrice, maxPrice);
