...
public class EntityManager<E> implements DbContext<E>{
    ...
    private boolean doUpdate(E entity, Field primaryKey) throws IllegalAccessException, SQLException {
        ...
        List<String> setFieldNameAndValues = Arrays.stream(entity.getClass().getDeclaredFields())
                .map(getFieldNameAndValues(entity))
    ...
    private Function<Field, String> getFieldNameAndValues(E entity) {
        return x -> {
    ...
    private void fillEntity(Class<E> table, ResultSet resultSet, E entity) throws SQLException, IllegalAccessException {
        ...
        for (Field field : declaredFields) {
            ...
            this.fillField(field, entity, resultSet, field.isAnnotationPresent(Id.class) ?
